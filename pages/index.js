    ...
    <div>
      ...
      <div className="flex container">
          ...
          <div className='content justify-center content-center flex-row pl-[20%] mt-10 pr-[20%]'>
            ...
            <div className='flex flex-col mt-20'>
              ...
              <div className='flex relative bg-transparent h-16 mt-4 items-center justify-center'>
                <input placeholder='Email Address'  className='text-sm placeholder-myred-700 bg-transparent border-2 rounded-full pl-10 flex-1 h-full'></input>
                <div className="w-[20%] absolute rounded-full right-0 items-center justify-center flex h-full gradient-btn shadow-xl shadow-fuchsia-200">
        ...
        <div className="basis-2/5 h-screen">
          <Image className='object-cover' src={dashboardImage} alt="beauty" />
        </div>
      </div>
    </div>
  )
